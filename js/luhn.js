...
setStep(
  "Choose Text",
  'Summarize',
  "Feel free to copy your text below or upload your document in docx, pdf, xlsx, csv, or json formats. You can select the text of interest using its number, and when you're ready, click on the 'Summarize' button to start.<br><br>Please note that currently, only text versions in PDF are supported. Support for PDFs with image content requiring OCR technology is a potential subject for future updates.<br><br>Rest assured that I will not keep any information from your document and stay tuned for the latest enhancements! &#128521",
  function step1() {
